...
def get_image():
    ...
    while not rospy.is_shutdown():
         ret, frame = cap.read()
         frame = cv.resize(frame, (1280, 960), interpolation=cv.INTER_CUBIC)
         
         #crop_img = frame[450:800, 60:1280]
         #print(frame.shape)
         #print(crop_img.shape)
         #cv.imwrite("carro_image.png", frame)
         #cv.imwrite("crop_image.png", crop_img)
